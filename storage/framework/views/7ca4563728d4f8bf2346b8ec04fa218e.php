...
<form action='<?php echo e(url('restoran/'.$data->nim)); ?>' method='post'>
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.tamplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CRUD\resources\views/webrestoran/edit.blade.php ENDPATH**/ ?>