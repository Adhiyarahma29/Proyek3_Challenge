        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form onsubmit="return confirm('Yakin akan menghappus data?')" class='d-inline' action="<?php echo e(url('mahasiswa/'.$item->nim)); ?>"method="post">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.tamplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CRUD\resources\views/mahasiswa/index.blade.php ENDPATH**/ ?>